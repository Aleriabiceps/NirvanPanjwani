...
function Boost() {
    return (
        <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: '"Arial", sans-serif' }}>
            ...
            <Paragraph>
                <span role="img" aria-label="wave">👋</span> Twitter is one of the best tools in a social media toolbox, due to its ability to let 280 character text bursts go viral within the hour. With an advertising audience of almost 300 million users, you’re bound to find a niche that your product fits in. 



            </Paragraph>
            <Paragraph>
                <span role="img" aria-label="wave">👋</span>  However, there is a steep learning curve, so here are 3 important lessons I’ve absorbed so far. 
            </Paragraph>
            <Paragraph>
